...
architectures:
  ...
  - arm64/v8
license: Apache-2.0
source: https://github.com/lxk36/xgc2-app-store
entrypoints:
  shell: /bin/bash
...
{chr(10).join(f"    - {t}" for t in tags)}
  ...
  limit: 0
  website: https://github.com/lxk36/xgc2-app-store
  github: https://github.com/lxk36/xgc2-app-store
  document: https://github.com/lxk36/xgc2-app-store/tree/master/apps/{key}
  architectures:
    - amd64
    - arm64/v8
